...
export function ShiftDisplayOptions({ value, onChange, axis, onAxisChange }: {
  value: ShiftDisplay; onChange: (value: ShiftDisplay) => void;
  axis: "driver" | "course"; onAxisChange: (axis: "driver" | "course") => void;
}) {
  return <div className="flex flex-wrap items-center gap-x-6 gap-y-3 rounded-lg border border-slate-200 bg-white p-3">
